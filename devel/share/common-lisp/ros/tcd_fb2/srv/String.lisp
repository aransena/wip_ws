...
(cl:defmethod cl:initialize-instance :after ((m <String-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcd_fb2-srv:<String-request> is deprecated: use tcd_fb2-srv:String-request instead.")))

(cl:ensure-generic-function 'exampleInput-val :lambda-list '(m))
(cl:defmethod exampleInput-val ((m <String-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcd_fb2-srv:exampleInput-val is deprecated.  Use tcd_fb2-srv:exampleInput instead.")
  (exampleInput m))
...
(cl:defmethod cl:initialize-instance :after ((m <String-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcd_fb2-srv:<String-response> is deprecated: use tcd_fb2-srv:String-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <String-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcd_fb2-srv:result-val is deprecated.  Use tcd_fb2-srv:result instead.")
  (result m))
